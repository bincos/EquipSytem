...
<nav class="art-nav">
    ...
    <ul class="art-hmenu">  <li><a href="index"  class="active" >Tâches</a></li>  <li><a href="equipList" >List Equip</a></li><li><a href="affectEquip" >Affectation</a></li> 
...
<li><a href="getReportIndex">Reporting</a> </li> </ul>
    ...
    <div class="art-layout-cell layout-item-0" style="width: 100%" >    
     ...
     <button  class="btn btn-success"><strong>${size }  Planifications </strong></button>
		...
		<div class="alert alert-success">  <h2>Taches Planifiés Pour aujourdh'ui !</h2><strong>   
		<a href="#" class="art-button"></a> </strong>
					...
					<f:hidden   path="param"  required="true" hint="param"  value="${idPlanExp }"/>
						...
						<input type="submit" value="${planToday}  Tâches Planifiés" class="art-button" >	
		 ...
		 <strong> ${thisArrayCurent}</strong>
			...
			<div class="alert alert-info"> <h2>Tâches Planifiés  avant  4 jours</h2>
			
			<a href="#" class="art-button">  ${plan3Days}  Tâches Planifiés</a> 
			<strong> ${thisArray}</strong>
			</div>
			
			<div class="alert alert-success">  <h2>Taches  Expirés Planifiés Non Validé !</h2>
					...
					<f:hidden   path="param"  required="true" hint="param"  value="${idPlanExp }"/>
						...
						<input type="submit" value="${expired}  Tâches Planifiés Expiré!!!" class="art-button" >	
		 ...
		 <strong> ${tacheExpired}</strong>
				...
				<div class="alert alert-danger"> <a href="planList" class="art-button">  <strong>Liste des Vos Tâches</strong></a> </div>
