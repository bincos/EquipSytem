...
<li><a href="trackIndex">Tracker Equip</a></li>  <li><a href="addPlan">Planifier  Tâches </a></li>  <li><a href="getReportIndex" class="active">Reporting</a> </li> </ul>
	...
	<!-- Le nom de notre exception -->
     ...
     <table  class="art-article" border="0" cellspacing="0" cellpadding="0">
					...
					<tr><td> Photo :</td><td><img src="photoEquip?idEquip=${equipDetails.id }" height="150px"/></td> </tr>
													
						</table>
     
                </div>
                  <c:if test="${ not empty Maintenance }">               
                  <f:form modelAttribute="searForm" action="addMaintenance" method="post">
			...
			<tr>
					...
					<td><f:errors path="mc" cssClass="error">
						...
						<input type="submit" value="Maintemance" class="btn btn-success"  style="width:30%"/></td>
					</tr>										
                    ...
                    <c:if test="${ not empty feadBack }">               
                  <f:form modelAttribute="searForm" action="addfeadBack" method="post">
