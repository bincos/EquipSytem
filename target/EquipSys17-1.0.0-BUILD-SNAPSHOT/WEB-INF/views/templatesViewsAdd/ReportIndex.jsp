...
<li><a href=registerUser>Ajouter User</a></li> <li><a href="addBesion" >Ajouter Besoin</a></li> <li><a href="addfeadBack"> FeadBack</a></li>
...
<li><a href="trackIndex">Tracker Equip</a></li> <li><a href="addPlan">Planifier  Tâches </a></li>
 <li><a href="getReportIndex">Reporting</a> </li> 
                        ...
                        <div class="art-layout-cell art-content"><article class="art-post art-article">
                                <h2 class="art-postheader">Reporting Module</h2>
                                                                          <div class="errors">
	${exception}
	<!-- Le nom de notre exception -->
       ...
       <f:form modelAttribute="reporting" action="getReportIndexB" enctype="multipart/form-data">
  <fieldset class="input" style="border: 0 none;">
      ...
      <label for="modlgn_photoprofile"> Date 1:</label>
      <f:input  type="date" name="date11"  class="inputbox"  path="date1"   required="true" style="width:100%" /> 
       <f:errors path="date11" cssClass="error"></f:errors>
     
    
    
         <p id="form-login-username">
      <label for="modlgn_photoprofile"> Date 2:</label>
      <f:input  type="date" name="date2"  class="inputbox"  path="date2"   required="true" style="width:100%" /> 
       <f:errors path="date2" cssClass="error"></f:errors>
        <f:hidden   name="mc"  class="inputbox"  path="mc"    value="${profileInSession.nameUser}" required="true" /> ${profileInSession.nameUser}
