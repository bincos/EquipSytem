...
<li><a href="trackIndex">Tracker Equip</a> </li>   <li><a href="addPlan">Planifier  Tâches </a></li>  <li><a href="getReportIndex" class="active">Reporting</a> </li> </ul>
    ...
    <div class="art-layout-cell layout-item-0" style="width: 100%" >    
			...
			<f:form modelAttribute="searForm" action="reportBtnX" method="post">
		<table class="art-article" border="0" cellspacing="0" cellpadding="0">
		<tr>	<h2> MODULE DE GENERATION DE RAPPORT</h2>	</tr>						
			<tr> <td>Date 1:</td> <td> Date 2 </td> <td>Option</td></tr>
			<tr>
							
					<td><f:input path="date1"  required="true" hint="Searche" type="date" />
					
					
				<f:errors path="mc" cssClass="error">
						</f:errors></td>
					
  
<td><f:input path="date2"  required="true" hint="Searche" type="date" /> 												
							
             <f:errors path="param" cssClass="error">
						</f:errors></td>
						
						
						<td><f:select path="param" required="true">
										<option></option>
       ...
       <td><f:hidden path="page"  value="search" hint="Enter un Mot clef"  />
        <f:hidden   name="mc"  class="inputbox"  path="mc"    value="${profileInSession.nameUser}" required="true" />
				<td> </td><td><input type="submit" value="RAPPORT"  class="art-button"/></td>
			</tr>
		</table>
	</f:form>
