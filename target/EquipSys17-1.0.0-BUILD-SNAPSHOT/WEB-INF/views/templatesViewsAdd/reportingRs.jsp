...
<h1> REPORTING FROM   [ '${reportingInfo.date1 }' ]  TO  [ '${reportingInfo.date2 }' ]  </h1>  </tr>
					...
					<h3>RAPPORT D'AFFECTATION DES EQUIPMENTS</h3>			
				...
				<tr>
					<th>ID</th>
					<th> Nom Equipment</th>
					<th class="success">Affected To</th>
				...
				<c:forEach items="${AffectList}" var="hr">
					<tr>
						...
						<td><strong>${hr.nameAffected }</strong></td>
						<td><strong>${hr.dateAff }</strong></td>
						...
						<td>
									...
									<tr> <td class="success">  <strong>TOTAL AFECTATION </strong></td> <td class="success"></td> <td class="success"><strong>${ sizeAff }</strong> </td></tr>
