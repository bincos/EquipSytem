...
<nav class="art-nav">
    ...
    <ul class="art-hmenu"> <li><a href="index"   >Tâches</a></li>  <li><a href="equipList" class="active" >Affectation</a></li> 
...
<div class="art-layout-wrapper">
        ...
        <div class="art-vmenublockcontent"> <ul class="art-vmenu"> <li><a href="addBesion" >Ajouter Besoin</a></li>
...
<li><a href="addPlan">Planifier  Tâches </a></li>  </ul>
    ...
    <div class="art-layout-cell layout-item-0" style="width: 100%" >    
			...
			<table title="Tableau d'affiche ListEquip Curent"  class="art-article" border="0" cellspacing="0" cellpadding="0">
					...
					<tr><td> Photo :</td><td><img src="photoEquip?idEquip=${EquipDetail.id }"  class="img-circle"  height="180px"/></td> </tr>
