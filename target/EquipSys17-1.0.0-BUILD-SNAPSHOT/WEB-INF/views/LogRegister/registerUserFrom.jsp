...
<div class="art-layout-wrapper">
 ...
 Caused :  
   ${sessionScope["SPRING_SECURITY_LAST_EXCEPTION"].message}  
         ...
         <f:form action="index">
         <input type="submit" value="HOME" name="Submit" class="art-button" />  
       ...
       <f:form modelAttribute="register" action="registerUserBtn" method="post" enctype="multipart/form-data">
  <fieldset class="input" style="border: 0 none;">
    ...
    <p id="form-login-username">
     ...
     <p id="form-login-password">
      ...
      <f:input type="password"  path="password"   alt="password" style="width:100%" id="modlgn_passwd" disabled="true"/> 
