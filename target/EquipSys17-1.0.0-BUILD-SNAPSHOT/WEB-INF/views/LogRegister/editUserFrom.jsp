...
<div class="art-layout-wrapper">
 ...
 Caused :  
   ${sessionScope["SPRING_SECURITY_LAST_EXCEPTION"].message}  
       ...
       <f:form modelAttribute="editUser" action="editUserBtn" method="post" enctype="multipart/form-data">
  <fieldset class="input" style="border: 0 none;">
    ...
    <input type="submit" value="Mise A Jour" name="Submit" class="art-button" />   <a href="login" class="active">LogIn</a>
