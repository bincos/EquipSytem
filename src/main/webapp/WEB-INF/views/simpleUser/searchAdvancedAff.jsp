...
<li><a href="trackIndex">Tracker Equip</a></li>  <li><a href="addPlan">Planifier  Tâches </a></li>  <li><a href="getReportIndex">Reporting</a> </li> </ul>
    ...
    <div class="art-layout-cell layout-item-0" style="width: 100%" >    
			...
			<f:form modelAttribute="searForm" action="searchBtnAvd" method="post">
		<table class="art-article" border="0" cellspacing="0" cellpadding="0">						
			<tr>
				<td>ID or Name :</td>
				
					<td><f:input path="mc"  required="true" hint="Searche" minlength="1" title="Saisir le nom ou l'ID de la personner Pour Affectation" />
				...
				<tr>
					...
					<f:hidden   path="param"  required="true" hint="Searche"  value="user"/>
						...
						<input type="submit" value="Ouvrir"  class="btn btn-success"/>									
							...
							<td>
						<f:form modelAttribute="searForm" action="affectValidation" method="post">
						<f:hidden   path="idUser"  required="true" hint="Searche"  value="${hr.id }"/>
					<f:hidden   path="idEquip"  required="true" hint="Searche"  value="${idEquip }"/>
					<f:hidden   path="mc"  required="true" hint="Searche"  value="${hr.nameUser }"/>
