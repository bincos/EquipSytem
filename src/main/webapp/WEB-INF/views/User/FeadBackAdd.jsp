...
<h1>SELECT EQUIMENT</h1>  </th></tr>
				...
				<c:forEach items="${AffectList}" var="hr">
					<tr>
						...
						<td>
						<f:form modelAttribute="editForm" action="feadBackD" method="post">
		
					<f:hidden   path="idEquip"  required="true" hint="Searche"  value="${hr.idEquip }"/>
					
						<input type="submit" value="FeadBack" class="art-button">								
	</f:form>											
