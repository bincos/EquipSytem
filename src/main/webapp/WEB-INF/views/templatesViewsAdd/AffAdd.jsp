...
<nav class="art-nav">
    ...
    <ul>
    <li><a href="index" >Tâches</a></li> <li><a href="equipList" >List Equip</a></li> <li><a href="affectEquip">Affectation</a></li>
...
<li><a href="trackIndex">Tracker Equip</a></li> <li><a href="addPlan">Planifier  Tâches </a></li> 
 <li><a href="getReportIndex">Reporting</a> </li> 
    ...
    <div class="art-layout-cell layout-item-0" style="width: 100%" >    
			...
			<table title="Selectionner Un Equippement à affecters"  class="art-article" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<th  >ID</th>
					<th>Non Equipment</th>
					<th>Model</th>
