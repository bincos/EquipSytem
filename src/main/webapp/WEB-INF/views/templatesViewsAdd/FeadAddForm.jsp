...
<ul class="art-vmenu"><li><a href="affectEquip" >Ajouter Equip</a></li>   <li><a href="registerCat" >Ajouter Cat</a></li> 
<li><a href=registerUser>Ajouter User</a></li>  <li><a href="addfeadBack" class="active"> FeadBack</a></li> <li><a href="addBesion" >Ajouter Besoin</a></li>
