...
<li><a href="trackIndex">Tracker Equip</a></li>   <li><a href="addPlan">Planifier  Tâches </a></li> <li><a href="getReportIndex">Reporting</a> </li> </ul>
  ...
  <fieldset class="input" style="border: 0 none;">
    ...
    <c:if test="${profilePicture.idUser !=null}">
				<img src="photoEquip?idEquip=${profilePicture.idUser}"/>	
...
<option></option>		
    ...
    <p id="form-login-username">
      ...
      <f:input type="text" name="decriptionEquip"  class="inputbox"  path="decriptionEquip"   cols="50" rows="10" required="true"/> 
